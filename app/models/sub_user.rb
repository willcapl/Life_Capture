  ...
  def content
    ...
    chaptgpt_response = client.chat(parameters: {
      ...
      messages: [{ role: "user", content: "Don't list the questions by number, just type | between each one. Your role
        ...
        Don't list the questions by number, just type | between each one. Also insert questions about their first job and their parents. Make the questions highly specific and ask
        about friends. Use | between questions."}]
    })
